...
public class LogFileMapper extends MapReduceBase implements
	...
	private static final Matcher monthm = Pattern.compile("(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sep|Oct|Nov|Dec)").matcher("");
	/*
	...
	public void map(LongWritable key, Text value,
		...
		monthm.reset(value.toString());
		if (ipm.find() && monthm.find()) {
			keyOut.set(ipm.group(0)+":"+monthm.group(0));
